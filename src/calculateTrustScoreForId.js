...
class TrustScore {
   ...
   */
  getTrustScore (businessUnitId) {
    return new Promise ((resolve, reject) => {
      this.prepareTrustScoreData(businessUnitId).then(() => {
        let response = {
          "id": this.business.id,
   ...
   */
  prepareTrustScoreData (businessUnitId) {
    return new Promise ((resolve, reject) => {
      this.getBusinessUnitInfo(businessUnitId).then((responseData) => {
        this.business.id = businessUnitId;
   ...
   */
  getBusinessUnitInfo (businessUnitId) {
    return new Promise ((resolve, reject) => {
      let infoPath = this.TP_ENDPOINTS.BUSINESS_INFO.replace('{businessUnitId}', businessUnitId);
      let options = {
...
exports.handler = (event, context, callback) => {
  ...
  trustScore.getTrustScore(event.params.businessUnitId).then((result) => {
